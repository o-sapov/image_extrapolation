...
Architectures file for CNN.
"""

import torch.nn as nn


class Ex5Cnn(nn.Module):
    def __init__(self, n_in_channels: int = 1, n_hidden_layers: int = 3, n_kernels: int = 32, kernel_size: int = 7):
        """Ex5Cnn with `n_hidden_layers`, `n_kernels`, and `kernel_size` as hyperparameters"""
        super(Ex5Cnn, self).__init__()
        ...
        self.output_layer = nn.Conv2d(in_channels=n_in_channels, out_channels=1,
